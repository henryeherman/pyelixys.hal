...
test_packet = ('?\x00\x00\x00\x10\x02\x00\x00\x00\x00\x00\x00A\x00\x00\x00d' 
                 '\x00\x00\x00\x00\x00\x00?d\x00\x00\x00\x00\x00\x00?d\x00\x00' 
                 '\x00\x00\x00\x00?d\x00\x00\x00\x00\x00\x00?\x00\x00\xaa\x00' 
                 '\xaa\x00\xaa\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A' 
                 '\x00\x00\xf0\x00\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00'  
                 '\x00\x00\x00\xc8A\x00\x00\x00\x00\x00\x00\xc8A\x00\x00\x00' 
                 '\x00\x00\x00 A\x00\x00\xa0@\x00\x00 A\x00\x00\xa0@\xa0\x00' 
                 '\x00\x00\xe8\x03\x00\x00\xd0\x07\x00\x00\x00\x00\x00\x00' 
                 '\xe8\x03\x00\x00\xd0\x07\x00\x00\x00\x00\x00\x00\xe8\x03' 
                 '\x00\x00\xd0\x07\x00\x00\x00\x00\x00\x00\xe8\x03\x00\x00' 
                 '\xd0\x07\x00\x00\x00\x00\x00\x00\xe8\x03\x00\x00\xd0\x07'  
                 '\x00\x00\x00\x00\x00\x00\x00\x00\xaa\xaa\x00\x00\x00\x00' 
                 '\x00\x00\xc0?\x00\x00\xc0?\x00\x00\xc0?\x00\x00\xc0?\x00' 
                 '\x00\xc0?\x00\x00\xc0?\x00\x00\xc0?\x00\x00\xc0?')
...
# Linear Axis #
#-------------#
for i in range(config['LinearAxis']['count']):
